...
proto.space.GetIdentityByUsernameResponse.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(1, f, proto.space.Identity.serializeBinaryToWriter);
    }
};
/**
...
proto.space.GetIdentityByUsernameResponse.prototype.getIdentity = function () {
    return /** @type{?proto.space.Identity} */ (jspb.Message.getWrapperField(this, proto.space.Identity, 1));
};
/**
