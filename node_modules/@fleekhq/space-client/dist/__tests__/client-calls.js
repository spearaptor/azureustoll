...
const client = new index_1.SpaceClient({ url: 'url' });
client.instance = {
...
it('listDirectory makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('listDirectories makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.listDirectories({
        bucket: 'my-bucket',
    });
    expect(client.instance.listDirectories).toHaveBeenCalledTimes(1);
}));
it('txlSubscribe makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.txlSubscribe({});
    expect(client.instance.txlSubscribe).toHaveBeenCalledTimes(1);
}));
it('openFile makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.openFile({
        bucket: 'my-bucket',
        path: '/',
    });
...
it('createBucket makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.createBucket({
        slug: 'my-bucket',
    });
    expect(client.instance.createBucket).toHaveBeenCalledTimes(1);
}));
it('addItems makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.addItems({
        bucket: 'my-bucket',
        targetPath: '/',
        sourcePaths: ['/a', '/b'],
...
it('createFolder makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.createFolder({
        bucket: 'my-bucket',
        path: '/',
    });
...
it('createUsernameAndEmail makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('getIdentityByUsername makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.getIdentityByUsername({
        username: 'fleek',
    });
    expect(client.instance.getIdentityByUsername).toHaveBeenCalledTimes(1);
}));
it('shareBucketViaEmail makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('shareBucketViaIdentity makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('generateFileShareLink makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
...
it('backupKeysByPassphrase makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.backupKeysByPassphrase({
        passphrase: '123',
    });
    expect(client.instance.backupKeysByPassphrase).toHaveBeenCalledTimes(1);
}));
it('recoverKeysByPassphrase makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.recoverKeysByPassphrase({
        passphrase: '123',
    });
    expect(client.instance.recoverKeysByPassphrase).toHaveBeenCalledTimes(1);
}));
it('toggleFuseDrive makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.toggleFuseDrive({
        mountDrive: true,
    });
    expect(client.instance.toggleFuseDrive).toHaveBeenCalledTimes(1);
}));
it('getFuseDriveStatus makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.getFuseDriveStatus({});
    expect(client.instance.getFuseDriveStatus).toHaveBeenCalledTimes(1);
}));
it('subscribe makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.subscribe();
    expect(client.instance.subscribe).toHaveBeenCalledTimes(1);
}));
it('listBuckets makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.listBuckets();
    expect(client.instance.listBuckets).toHaveBeenCalledTimes(1);
}));
it('shareBucket makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.shareBucket({
        bucket: 'my-bucket',
    });
    expect(client.instance.shareBucket).toHaveBeenCalledTimes(1);
}));
it('joinBucket makes the right requests', () => __awaiter(void 0, void 0, void 0, function* () {
    client.joinBucket({
        bucket: 'my-bucket',
        threadInfo: {
            key: '123',
